...
**ogry-panel (.env.local or .env):**
```env
VITE_API_URL=http://localhost:3000
VITE_USE_BACKEND_CABINS=true
```
...
**ogry-panel:**
```env
VITE_USE_BACKEND_CABINS=false
# VITE_API_URL can be removed or set to real backend URL
```
